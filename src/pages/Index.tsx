  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-2xl text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            Create your personal website <br /> in minutes
          </h1>

          <p className="text-muted-foreground">
            Build a clean professional portfolio, manage content easily and publish your own personal website with your own link.
          </p>

          <div className="flex justify-center gap-4 pt-4">
            <Link to="/register">
              <Button size="lg">
                Create my page <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
            </Link>
            <Link to="/login">
      ...
      <footer className="border-t py-6 text-center text-sm text-muted-foreground">
        © {year} Portfolify. All rights reserved.
      </footer>
    </div>
  );
};
